...
const Movie = ({item}) => {
  ...
  return (
    <div className='w-[180px] sm:w-[200px] md:w-[240px] lg:w-[450px] inline-block cursor-pointer relative p-2 group'>
        <img className='transition duration shadow-xl rounded-md group-hover:opacity-90 sm:group-hover:opacity-0 delay-150 w-full h-full' src={`https://image.tmdb.org/t/p/w500/${item?.backdrop_path}`} alt={item?.title} />
